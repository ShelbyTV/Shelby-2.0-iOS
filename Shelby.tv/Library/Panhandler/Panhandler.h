...
#define PanhandlerTrigger       50                  // Number (integer) of events needed for ratings reminder alert
#define PanhandlerRetrigger     50                  // Number (integer) of events needed to retrigger ratings reminder alert 
